...
This code supports three medical image segmentation datasets:

### CHAOST2
- **Description**: Abdominal MRI T2-weighted images from the CHAOS Challenge
- **Organs**: Liver, Right Kidney, Left Kidney, Spleen (4 classes)
- **Samples**: 20 cases
- **Download**: [CHAOS Challenge](https://chaos.grand-challenge.org/)

### CMR
- **Description**: Cardiac MRI images
- **Structures**: LV-MYO (Left Ventricle Myocardium), LV-BP (Left Ventricle Blood Pool), RV (Right Ventricle) (3 classes)
- **Samples**: 35 cases
- **Note**: Please refer to the original paper for dataset access

### SABS
- **Description**: Abdominal CT images
- **Organs**: 13 abdominal organs (Spleen, Kidneys, Liver, etc.)
- **Samples**: 30 cases
- **Note**: Please refer to the original paper for dataset access

**Note**: The datasets need to be preprocessed and organized according to the structure below. Supervoxel segmentation is required for training with supervoxel labels.
